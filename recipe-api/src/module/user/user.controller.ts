  ...
  public async updateUser(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      if (rollid === 1) {
        ...
        return res.status(404).json({ error: "can not update user u are authorized!!" });
      }
    } catch (err) {
  ...
  public async deleteUser(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      if (rollid === 1) {
        ...
        return res.status(404).json({ error: "cannot delete any user u are not authorized!!" });
      }
    } catch (err) {
